...
def print_direction():
    ...
    east=locations[current_location]['east']   #get the value for the different directions
...
def go_west():
    ...
    if west<=0:
        ...
        print_location(0)  #the zero is there to make sure the verbose/brief setting is adhered to
